...
- Quick actions: last-wake Fix it card, history swipe (settings/mute), QuickFix bottom sheet, detail screen silence/settings buttons, ChannelMuter via NLS dismiss + settings deep links, wake/latest/actions and app/quickfix deep links (M4).
...
Future releases will be listed here as milestones ship:

- `[1.1.0]` — M6: widget, Quick Settings tile, pattern detection, heatmap
- `[1.0.0]` — M5: first stable F-Droid release
