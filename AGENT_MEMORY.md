...
| Date | Event |
|------|-------|
| 2026-07-22 | **v1.2.16 ship prep:** Wake Shield thrash hardening (no POWER toggle; cooldown/self-wake before L1–L3; no second dumpsys). Device heat triage: Life360 GPS + Huawei Health minute wakes primary; app not CPU-bound. m14_smoke + memory baseline PASS `b5214fc6` CPH2583; m13_adb_verify blocked (lock screen). |
