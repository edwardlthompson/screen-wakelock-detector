...
- **SMOKE_PIN** — OP13 (`8bf09993`) lock screen blocks `m13_adb_verify` / full `m14_regression` UI steps until `.env` has `SMOKE_PIN=` or device unlocked manually.
...
| Date | Event |
|------|-------|
| 2026-08-22 | **v1.2.19 released:** https://github.com/edwardlthompson/screen-wakelock-detector/releases/tag/v1.2.19 — donate, GitHub APK checks, Shield dry-run, tonight Home; Android CI https://github.com/edwardlthompson/screen-wakelock-detector/actions/runs/32615484756 ; ship regress m14_smoke + memory PASS `b5214fc6` CPH2583 (warm PSS≈86MB); m13_adb_verify PARTIAL. |
| 2026-08-20 | **v1.2.18 released:** https://github.com/edwardlthompson/screen-wakelock-detector/releases/tag/v1.2.18 — Wake Shield visibility, night-only ignore, attribution fallback, F-Droid listing pack; Android CI https://github.com/edwardlthompson/screen-wakelock-detector/actions/runs/32427254759 ; Release https://github.com/edwardlthompson/screen-wakelock-detector/actions/runs/32427258079 ; ship regress m14_regression PASS `b5214fc6` CPH2583 1.2.18 (PSS≈167MB). |
