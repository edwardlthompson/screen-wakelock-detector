...
| Date | Event |
|------|-------|
| 2026-08-20 | **v1.2.17 prep:** high-refresh display preference + FOSS Cursor surface. Pre-release: feature-gate PASS; m14_smoke + memory baseline CPH2583 PASS (PSS≈167MB `b5214fc6`); m13_adb_verify PARTIAL (Settings Ignored apps scroll). CI wait on unpushed HEAD deferred to `/push`. |
