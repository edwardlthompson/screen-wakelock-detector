...
| Date | Event |
|------|-------|
| 2026-08-22 | **v1.2.19 prepare:** donate + GitHub update checks + M19 slices; lint/test/assemble + feature-gate + m14_smoke PASS on `b5214fc6`; CPH2583 memory baseline rebased PSS≈214MB / Java heap≈48MB; m13_adb_verify PARTIAL (QuickFix visible on-device, dump/focus flake). |
